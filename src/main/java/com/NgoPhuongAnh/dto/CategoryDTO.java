...
public class CategoryDTO {
    ...
    @NotBlank(message = "Tên danh mục loại không được để trống")
    @NotNull(message = "Tên danh mục loại không được để null")
    @NotEmpty(message = "Tên danh mục loại không được để rỗng")
    @Size(max = 500, message = "Tên danh mục loại không được vượt quá 500 ký tự")
    String name;

    @NotBlank(message = "Ghi chú không được để trống")
    @NotNull(message = "Ghi chú khoogn được để null")
    @NotEmpty(message = "Ghi chú không được để rỗng")
    String notes;

    @NotBlank(message = "Hình ảnh cho danh mục không được để trống")
    @NotNull(message = "Hình ảnh cho danh mục không được để null")
    @NotEmpty(message = "Hình ảnh cho danh mục không được rỗng")
    @Size(max = 250, message = "Hình ảnh cho danh mục không được vượt quá 250 ký tự")
    String icon;

    @NotNull(message = "Id danh mục cha không được để null")
    @NotEmpty(message = "Id danh mục cha khoogn được để rỗng")
    Long idParent;

    @NotBlank(message = "Url không được để trống")
    @NotNull(message = "Url không được để null")
    @NotEmpty(message = "Url không dược để rỗng")
    ...
    @NotBlank(message = "Từ khoá không được để trống")
    @NotNull(message = "Từ khóa không đuợc để null")
